...
#else
    if (SSTATW(G.unipath_widefilename, &G.statbuf) == 0)
#endif /* ?SYMLINKS */
    {
...
#else
        G.outfile = zfopenw(G.unipath_widefilename, L"wb");
#endif
#if defined(ATH_BE_UNX) || defined(AOS_VS) || defined(QDOS) || defined(TANDEM)
        umask(umask_sav);
#endif
...
#define VMSREC_C_VAR    2
 ...
 /* uch vms_fileorg = 0; */ /* currently, fileorg is not used needed... */
